...
(function() {
    ...
    YAHOO.extend(Alfresco.Search, Alfresco.component.SearchBase, {
        ...
        onReady: function Search_onReady() {
            ...
            this.rootNode = Alfresco.util.getQueryStringParameter('rootNode');
        ...
        refreshSearch: function Search_refreshSearch(args) {
            ...
            console.log("refreshSearch:" + rootNode);
            ...
            if (rootNode != null && rootNode.length !== 0) {
                // if we have a query (already encoded), then apply it
            	// #issue2071 sorting issue after advanced search - "&r" included to search in repository
                url += "&r=" + searchRepository +  "&rootNode=" + rootNode;
            } else {
        ...
        _performSearch: function Search__performSearch(args) {
            ...
            this.widgets.dataSource.sendRequest(this._buildSearchParams(searchRepository, searchAllSites, searchTerm, searchTag, searchSort, rootNode, page), {
        ...
        _buildSearchParams: function Search__buildSearchParams(searchRepository, searchAllSites, searchTerm, searchTag, searchSort, rootNode, page) {
            ...
            var params = YAHOO.lang.substitute("site={site}&term={term}&tag={tag}&maxResults={maxResults}&sort={sort}&query={query}&repo={repo}&rootNode={rootNode}&pageSize={pageSize}&startIndex={startIndex}&rootNode={rootNode}", {
