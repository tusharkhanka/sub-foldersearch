...
(function() {
    ...
    YAHOO.extend(Alfresco.AdvancedSearch, Alfresco.component.Base, {
                            ...
                            if (element.type === "hidden") {
                                ...
                                if (cntrl) {
                                    ...
                                    case "checkbox":
                                        ...
                                        break;
                                    default:
                                        // "select-multiple" - and potentially others following the same pattern
                                        cntrl.value = savedValue;
                                        break;
                                    }
                                }
        ...
        onSearchClick: function ADVSearch_onSearchClick(e, obj) {
            ...
            //var url = YAHOO.lang.substitute(Alfresco.constants.URL_PAGECONTEXT + "{site}search?t={terms}&q={query}&scope={scope}&r={repo}&rootNode={container}", {
